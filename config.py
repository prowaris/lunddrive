...
ADMIN_PASSWORD = os.getenv("ADMIN_PASSWORD", "mrwaris04")  # Default to "admin" if not set
...
TELEGRAM_ADMIN_IDS = os.getenv("TELEGRAM_ADMIN_IDS", "6419031539 1938532284").strip(", ").split(",")
