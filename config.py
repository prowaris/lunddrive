...
API_ID = int(os.getenv("24184946"))  # Your Telegram API ID
API_HASH = os.getenv("db7aa8593d6422dd3924f629d6cbe808")  # Your Telegram API Hash
...
STORAGE_CHANNEL = int(os.getenv("-1002394885619"))  # Your storage channel's chat ID
